...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
function upload(selector) {
  ...
  var open_btn = element('button', ['container__btn'], 'Open');
  var clean_btn = element('button', ['container__btn', 'primary'], 'Clean');
  var upload_btn = element('button', ['container__btn', 'primary'], 'Upload');
  clean_btn.style.display = 'none';
  upload_btn.style.display = 'none';
  clean_btn.addEventListener('click', function (event) {
    preview.innerHTML = '';
    clean_btn.style.display = 'none';
    upload_btn.style.display = 'none';
  });
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, i) {
      ...
      task.on('state_changed', function (snapshot) {
        ...
        var block = blocks[i].querySelector('.preview__info_progress');
...
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js","./main.js":"main.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
